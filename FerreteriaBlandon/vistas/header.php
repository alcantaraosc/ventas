          ...
          <li class="dropdown user user-menu">
            ...
            <ul class="dropdown-menu">
              ...
              <li class="user-header">
                ...
                <p>
                  Lester Eliezer  -Desarrollo de software
                  <small>Octubre 2021</small>
                </p>
              </li>
              <!-- Menu Footer-->
...
if ($_SESSION['consultav']==1) {
  echo '<li class="treeview">
        ...
        <li><a href="https://www.facebook.com/FerreteriablandonMaterialesdeCostruccion/"><i class="fa fa-question-circle"></i> <span>Facebook</span><small class="label pull-right bg-yellow">PDF</small></a></li>
